...
df = pd.DataFrame(pd.read_csv("/results/ds_fin2.csv"))
...
Unaugmented data
# Trial 124 finished with value: 0.8615350829032612 and parameters: {'booster': 'gbtree', 'lambda': 1.5615836733448351e-06, 'alpha': 4.5976655352036944e-09, 'subsample': 0.8986744131212778, 'colsample_bytree': 0.5485891261507573, 'max_depth': 33, 'min_child_weight': 10, 'eta': 0.2956636103748818, 'gamma': 0.13361665367776615, 'grow_policy': 'lossguide'}. Best is trial 124 with value: 0.8615350829032612.
# [I 2025-03-06 04:20:08,337] Trial 8 finished with value: 0.8627429629440826 and parameters: {'n_neighbors': 15, 'metric': 'manhattan', 'leaf_size': 56}. Best is trial 8 with value: 0.8627429629440826.
# [I 2025-03-06 02:48:50,222] Trial 4 finished with value: 0.8639416677758552 and parameters: {'rf_max_depth': 15, 'rf_n_estimators': 103}. Best is trial 4 with value: 0.8639416677758552.
# [I 2025-03-06 05:02:13,372] Trial 3 finished with value: 0.8621115678470688 and parameters: {'gb_n_estimators': 30, 'gb_learning_rate': 0.019473407453793192, 'gb_max_depth': 12}. Best is trial 3 with value: 0.8621115678470688.
